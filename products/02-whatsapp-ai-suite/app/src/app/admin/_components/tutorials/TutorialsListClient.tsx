...
interface Props {
  productId: string;
  /**
   * URL path segment inserted after "/admin/", e.g. "p02-chatbase".
   * When empty string (standalone app), links go to "/admin/tutorials/...".
   */
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          href={productSegment.length > 0 ? `/admin/${productSegment}/tutorials/new` : "/admin/tutorials/new"}
              ...
              <tr key={row.id} className="bg-zinc-950 hover:bg-zinc-900 transition-colors">
                ...
                <td className="px-4 py-3 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <Link
                      href={productSegment.length > 0 ? `/admin/${productSegment}/tutorials/${row.id}/edit` : `/admin/tutorials/${row.id}/edit`}
