/**
 * TableFlow — canonical site URL.
 *
 * Set NEXT_PUBLIC_APP_URL on Vercel (production target) to the real domain
 * once the founder assigns one (e.g. https://tableflow.addonweb.io).
 *
...
export const SITE_BASE_URL: string =
  process.env["NEXT_PUBLIC_APP_URL"] ?? "https://tableflow-addonweb.vercel.app";
