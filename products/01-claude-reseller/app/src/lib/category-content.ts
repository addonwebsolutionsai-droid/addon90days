...
export const CATEGORY_CONTENT: Record<string, CategoryContent> = {
  "indian-business": {
    ...
    emoji: "🇮🇳",
    color: "#f97316",
    titleTag:        "Claude Skills for Indian Business — GST, Tally, Invoicing",
  ...
  "iot": {
    ...
    emoji: "📡",
    color: "#06b6d4",
    titleTag:        "Claude Skills for IoT & Hardware — ESP32, MQTT, OTA",
  ...
  "developer-tools": {
    ...
    emoji: "⚡",
    color: "#f59e0b",
    titleTag:        "Claude Skills for Developer Tools — SQL, Code Review",
  ...
  "trading-finance": {
    ...
    emoji: "📉",
    color: "#eab308",
    titleTag:        "Claude Skills for Trading & Finance — NSE, Backtest",
  ...
  "ai-llm": {
    ...
    emoji: "🤖",
    color: "#8b5cf6",
    titleTag:        "Claude Skills for AI & LLM — Prompt, RAG, Multi-Agent",
  ...
  "startup-product": {
    ...
    emoji: "🚀",
    color: "#ec4899",
    titleTag:        "Claude Skills for Startup & Product — PRD, Roadmap",
  ...
  "ui-ux": {
    ...
    emoji: "🎨",
    color: "#10b981",
    titleTag:        "Claude Skills for UI/UX — Design Tokens, Components",
  ...
  "data-analytics": {
    ...
    emoji: "📊",
    color: "#3b82f6",
    titleTag:        "Claude Skills for Data & Analytics — SQL, Dashboard",
  ...
  "devops-infra": {
    ...
    emoji: "🛠",
    color: "#6366f1",
    titleTag:        "Claude Skills for DevOps & Infra — CI/CD, K8s",
  ...
  "communication-protocols": {
    ...
    emoji: "🔗",
    color: "#14b8a6",
    titleTag:        "Claude Skills for Communication Protocols — MQTT, gRPC",
  ...
  "marketing-growth": {
    ...
    emoji: "📈",
    color: "#f43f5e",
    titleTag:        "Claude Skills for Marketing & Growth — SEO, Email",
