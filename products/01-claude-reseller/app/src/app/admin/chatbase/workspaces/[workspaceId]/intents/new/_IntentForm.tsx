 ...
 * Used by /admin/chatbase/workspaces/[workspaceId]/intents/new
 */
...
export function IntentForm({ workspaceId }: Props) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/admin/chatbase/workspaces/${workspaceId}/intents`, {
        method:  "POST",
      ...
      startTransition(() => router.push(`/admin/chatbase/workspaces/${workspaceId}`));
    } catch (err) {
