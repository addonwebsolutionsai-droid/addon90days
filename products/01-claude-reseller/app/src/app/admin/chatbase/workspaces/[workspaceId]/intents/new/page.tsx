/**
 * /admin/chatbase/workspaces/[workspaceId]/intents/new
 *
 * Server shell + client form for creating a new workspace-specific intent.
 */
...
import { IntentForm } from "./_IntentForm";
...
export default async function NewIntentPage(ctx: RouteContext) {
  ...
  return (
    <div className="space-y-5 max-w-2xl">
      <Link
        href={`/admin/chatbase/workspaces/${workspaceId}`}
      ...
      <header>
        ...
        <h1 className="text-2xl font-bold">Add custom intent</h1>
