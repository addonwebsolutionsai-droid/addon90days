/**
 * /admin/p05-connectone — P05 ConnectOne per-product admin shell.
 */
...
export const metadata = { title: "ConnectOne · Admin" };

const PRODUCT_KEY = "p05-connectone";
const PRODUCT_NAME = "ConnectOne";
// Cyan — P05 brand color
const ACCENT = "#06b6d4";
...
export default function ConnectoneAdminLayout({ children }: { children: React.ReactNode }) {
  return (
