/**
 * /admin/p06-machineguard — P06 MachineGuard per-product admin shell.
 */
...
export const metadata = { title: "MachineGuard · Admin" };

const PRODUCT_KEY = "p06-machineguard";
const PRODUCT_NAME = "MachineGuard";
// Amber — P06 brand color
const ACCENT = "#f59e0b";
...
export default function MachineguardAdminLayout({ children }: { children: React.ReactNode }) {
  return (
