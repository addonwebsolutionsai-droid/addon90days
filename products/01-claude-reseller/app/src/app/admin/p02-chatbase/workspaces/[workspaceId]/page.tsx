/**
 * /admin/p02-chatbase/workspaces/[workspaceId]
 *
  ...
  return (
    <div className="space-y-6">
      ...
      <Panel
        ...
        action={
          <Link
            href={`/admin/p02-chatbase/workspaces/${workspaceId}/intents/new`}
          ...
          {[...customIntents, ...globalIntents].map((i) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 mt-1.5">
                ...
                {i.workspace_id !== null && (
                  <Link
                    href={`/admin/p02-chatbase/intents/${i.id}/edit`}
      ...
      <Panel
        ...
        action={
          <Link
            href={`/admin/p02-chatbase/workspaces/${workspaceId}/kb/new`}
            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-violet-600 hover:bg-violet-500 text-white text-[11px] font-medium transition-colors"
          >
        ...
        {conversations.length === 0 ? (
          ...
          <div className="space-y-1.5">
            {conversations.map((c) => (
              <Link
                key={c.id}
                href={`/admin/p02-chatbase/conversations/${c.id}`}
