/**
 * /admin/p01-skilon — P01 SKILON per-product admin shell.
 *
 * Server component. Active-link state is delegated to the thin
 * <ProductSubNav> client component so this layout stays RSC.
 */
...
export const metadata = { title: "SKILON · Admin" };

const PRODUCT_KEY = "p01-skilon";
const PRODUCT_NAME = "SKILON";
// Violet — P01 brand color
const ACCENT = "#8b5cf6";
...
export default function SkILONAdminLayout({ children }: { children: React.ReactNode }) {
  return (
