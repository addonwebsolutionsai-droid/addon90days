/**
 * /admin/p03-taxpilot — P03 TaxPilot per-product admin shell.
 */
...
const PRODUCT_KEY = "p03-taxpilot";
const PRODUCT_NAME = "TaxPilot";
// Blue — P03 brand color
const ACCENT = "#3b82f6";
...
export default function TaxpilotAdminLayout({ children }: { children: React.ReactNode }) {
  return (
