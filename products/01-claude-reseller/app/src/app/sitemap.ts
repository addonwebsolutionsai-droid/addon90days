...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/taxpilot`,       lastModified: now, changeFrequency: "weekly",  priority: 0.7 },
    { url: `${baseUrl}/tableflow`,      lastModified: now, changeFrequency: "weekly",  priority: 0.7 },
    { url: `${baseUrl}/connectone`,     lastModified: now, changeFrequency: "weekly",  priority: 0.7 },
    { url: `${baseUrl}/machineguard`,   lastModified: now, changeFrequency: "weekly",  priority: 0.7 },
