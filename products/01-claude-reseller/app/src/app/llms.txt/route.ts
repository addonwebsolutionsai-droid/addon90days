 ...
 * can answer "what is the AddonWeb Claude Toolkit" without scraping our
...
const CONTENT = `# AddonWeb Claude Toolkit

> 130 production-ready Claude skills, MCP servers, and agent bundles. Free during public beta — no credit card, no paywall, no usage cap. 1-line install. Ships in minutes.

## What it is

AddonWeb Claude Toolkit is a marketplace of structured prompts ("skills") for Claude Code and Claude Desktop. Each skill is a defined input schema + step-by-step workflow + copy-paste output — not a chatbot conversation, a repeatable production workflow.
