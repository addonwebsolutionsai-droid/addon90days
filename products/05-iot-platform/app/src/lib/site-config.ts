/**
 * ConnectOne — canonical site URL.
 *
 * Set NEXT_PUBLIC_APP_URL on Vercel (production target) to the real domain
 * once the founder assigns one (e.g. https://connectone.addonweb.io).
 *
...
export const SITE_BASE_URL: string =
  process.env["NEXT_PUBLIC_APP_URL"] ?? "https://connectone-addonweb.vercel.app";
