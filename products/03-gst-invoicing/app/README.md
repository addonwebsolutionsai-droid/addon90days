# TaxPilot — P03 GST + invoicing for Indian SMBs

Future home of the standalone Next.js app for this product.

## Status

**Phase 0 placeholder.** Today, TaxPilot-related code (if any) lives inside `products/01-claude-reseller/app/` mixed with SKILON. The extraction to this dedicated app happens in a later phase per the multi-app split plan:
