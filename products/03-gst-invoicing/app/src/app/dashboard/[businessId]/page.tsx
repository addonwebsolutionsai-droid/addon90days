/**
 * /dashboard/[businessId] — business overview.
 *
    ...
    <div className="max-w-4xl mx-auto px-5 py-10">
      ...
      <header className="flex items-start justify-between flex-wrap gap-3 mb-6">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <Link
            href={`/dashboard/${business.id}/customers/new`}
          ...
          <Link
            href={`/dashboard/${business.id}/invoices/new`}
            ...
            <ul className="divide-y" style={{ borderColor: "var(--border-subtle)" }}>
              {invoices.slice(0, 10).map((inv) => (
                <li key={inv.id} style={{ borderColor: "var(--border-subtle)" }}>
                  <Link
                    href={`/dashboard/${business.id}/invoices/${inv.id}`}
